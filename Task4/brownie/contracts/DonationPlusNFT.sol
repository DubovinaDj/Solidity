/*Task 2 [MEDIUM]:
Koristeci Hardhat prosiriti funkcionalnost inicijalnog contracta. 
Funkcionalnosti su popisane u Solidity interfejsu koji glavni contract treba da implementira. 
Kreirati NFT - Non Fungible Token prateci ERC-721 standard. 
Svaki korisnik prilikom prve donacije na poklon dobija 1 NFT koji ste kreirali. 
Deployovati smart contracte na testnet po izboru i verifikovati ih na Etherscanu.
*/
...
//import "@openzeppelin-contracts@4.0.0/contracts/access/Ownable.sol";
...
contract Donation is Ownable {
    ...
    function setNFTAddress(address _address) public onlyAdmin {
